...
import { getInvite, dbConfigured } from "./_db.js";
...
export default async function handler(req, res) {
  ...
  return res.status(200).json({
    status, email: inv.email, espace: inv.espace || "", role: inv.role || "Lecteur",
    activatedAt: inv.activatedAt || null, expiresAt: inv.expiresAt || null,
  });
}
